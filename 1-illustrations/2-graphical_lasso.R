...
out=GraphicalModel(data=simul$data, PFER_thr=10, PFER_method="MB")
A=Adjacency(out)
...
{pdf("Figures/1-illustrations/Figure1_graphical_model.pdf", width=15, height=7)
  # Calibration plot
  CalibrationPlot(out, mfrow=c(1,2), mar=c(7,5,5,5))
  ...
  legend(x=-1.2,y=-0.2, col=c("navy", "tomato", "forestgreen"), 
