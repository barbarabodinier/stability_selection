...
dnam=dnam[,apply(dnam, 2, FUN=function(x){sum(is.na(x))/length(x)})<0.3]
...
# table(huan$Meta.P.Value<0.05/17873, huan$`Discovered.in.IllumiNo.cohorts.&.Validated.in.FHS.cohorts`)
# table(huan$Meta.P.Value<0.05/17873)
