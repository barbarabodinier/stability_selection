...
#setwd(paste0("../../Results/1-graphical_model/Sensitivity_K_",simul_study_id,"_",topology))
setwd(paste0("../../Results/1-graphical_model/Former/Sensitivity_K_",simul_study_id,"_",topology))
