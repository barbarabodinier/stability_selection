...
setwd(paste0("../../Results/2-multi_block/Simulations_", simul_study_id, "_", topology))

myfiles <- list.files(pattern = paste0("Performances", data))
myfiles <- myfiles[grep(paste0("Performances_single_nu.*_", i, "_.*_PFER_thr_Inf.rds"), myfiles)]
...
saveRDS(results, paste0("Performances_single_", i, "_merged_PFER_thr_Inf.rds"))
