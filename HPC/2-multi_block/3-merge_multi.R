...
myfiles=myfiles[grep(paste0("Performances_multi_nu.*_",i,"_.*_PFER_thr_Inf.rds"), myfiles)]
...
saveRDS(results, paste0("Performances_multi_",i,"_merged_PFER_thr_Inf.rds"))
