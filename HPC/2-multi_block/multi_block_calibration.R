...
filepath <- paste0("../../Results/2-multi_block/Simulations_", simul_study_id, "_", topology, "/")
...
foo_unconstr <- function() {
  out <- GraphicalModel(xdata = simul$data, pk = pk, Lambda = Lambda_single, lambda_other_blocks = 0.1, start = "cold", PFER_method = "MB")
